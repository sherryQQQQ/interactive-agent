...
- Added a privacy-minimal MIRAGE checkpoint replay: one paired sample per case,
  strict duplicate/completeness checks, source fingerprinting and normalized
  three-arm scores. The 100-case Agent v2 replay reproduced 84%/78%/76% with
  zero model usage; this is migration validation, not a new experiment.
...
Validation on the local Python 3.13 environment: 163 tests and 3 subtests
